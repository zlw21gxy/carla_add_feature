...
SERVER_BINARY = os.environ.get("CARLA_SERVER",
                               os.path.expanduser("/home/gu/Documents/carla/CarlaUE4.sh"))     # the carla8 engine
...
if "CARLA_PY_PATH" in os.environ:
    ...
    sys.path.append(os.path.expanduser("/home/gu/Documents/carla/PythonClient/"))             # the carla8 python API
...
ENV_CONFIG = {
    ...
    "scenarios": TOWN2_ONE_CURVE, # TOWN2_ONE_CURVE_0, #TOWN2_STRAIGHT_0, # TOWN2_STRAIGHT_DYNAMIC_0, #  [DEFAULT_SCENARIO], # [LANE_KEEP], #  TOWN2_ONE_CURVE, #    TOWN2_ALL, #
...
class CarlaEnv(gym.Env):
    ...
    def _read_observation(self):
        ...
        if next_command == "REACH_GOAL":
            ...
            self.distance_collect = np.append(self.distance_collect, distance_to_goal)
            if len(self.distance_collect) > 2:
                ...
                distance_change = self.distance_collect[1:] - self.distance_collect[:-1]
